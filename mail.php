...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	try {
		...
		$from = ("1" == "1" ? $_POST["email"] : "matthieu.nicaise@outlook.com");

		// Sender as From Name or predefined From Name
		$fromName = "";
		if ("1" == "1") {
			$fromName = "Friends Truck";
		...
		$fromName = ($fromName ? $fromName : "Friends Truck");
		...
		// Send the mail
		if ( mail("Friends.truck@outlook.com", $subject, $body, $headers) ) {
			json(true);
		}
	}
	catch (Exception $e) {
